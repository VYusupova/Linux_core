# Сети в Linux
Выход можно делать комбинацией Ctrl-D  
выключить компьютер  `sudo shutdown -h now` 
`ip a` 

https://losst.pro/vyklyuchenie-linux-iz-komandnoj-stroki#toc-1-shutdown
...
<details>
 <summary> Part 1. Инструмент ipcalc </summary>
...
<details>
 <summary> Статическая маршрутизация между двумя машинами </summary>
